...
**دستیار هوشمند فارسی برای کارهای روزمره.**
...
**[روی OpenMuse (پروژهٔ بالادستی) چیزی می‌سازید؟ با تیم CopilotKit دیدار کنید ←](https://www.copilotkit.ai/openmuse)**

[![دستیار جی‌پی‌تی 🪁: از آن بخواهید مرور کند. نمایش ۳۸ ثانیه‌ای موبایل را ببینید.](assets/demos/2026-09-16/mobile.png)](assets/demos/2026-09-16/mobile.mp4)

**[تماشای نمایش موبایل · ۳۸ ثانیه](assets/demos/2026-09-16/mobile.mp4)**

[![دستیار جی‌پی‌تی 🪁 در وب: نمایش ۴۲ ثانیه‌ای دسکتاپ را ببینید.](assets/demos/2026-09-16/web.png)](assets/demos/2026-09-16/web.mp4)
...
## دستیار جی‌پی‌تی چیست

دستیار جی‌پی‌تی یک برنامهٔ دستیار شخصی با رایانهٔ عامل، کار قابل‌مشاهده و نتایج غنی است. سرور، پردازشگر وظایف و کارگر مرورگر خودش را اجرا می‌کند. می‌توانید کد منبع را تحت مجوز MIT بررسی و تغییر دهید.
...
برای استقرار دستیار جی‌پی‌تی روی زیرساخت ابرآروان (ArvanCloud)، راهنمای [deploy/arvan/README.fa.md](deploy/arvan/README.fa.md) را دنبال کنید.

استقرار آزمایشی فعلی در <span dir="ltr">[https://37-32-27-135.sslip.io](https://37-32-27-135.sslip.io)</span> در دسترس است.
...
با مجوز MIT. دستیار جی‌پی‌تی بر پایهٔ [OpenMuse ساختهٔ CopilotKit (مجوز MIT)](https://github.com/CopilotKit/OpenMuse) ساخته شده است؛ این مخزن فورکی از پروژهٔ اصلی [CopilotKit/OpenMuse](https://github.com/CopilotKit/OpenMuse) است و رابط اصلی و دارایی‌های فرضی آن را در بر دارد. محتوای وب‌سایت‌ها، ایمیل‌ها و اسناد فقط شاهد و قرینه فراهم می‌کند، نه اجازهٔ اقدام.
