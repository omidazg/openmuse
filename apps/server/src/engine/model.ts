...
export async function executeModelTask(
  ...
  const tools = [
    ...
    iranCalendarTool(),
    ...visionTools(service.files, owner),
    tool(
      "read_file",
